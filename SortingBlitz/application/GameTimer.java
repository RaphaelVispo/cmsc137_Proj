...
public class GameTimer extends AnimationTimer {
	...
	public void handle(long currentNanoTime) {
        ...
        updateScore(newPlayer.getScore());
    ...
    public void generatePotion() {
    	...
    	int maxX = (int) (SceneController.screenWidth * 0.8 -potionSizes.get("height") -  marginLeftRight) ;

    	int minY = marginTop;
    	int maxY = (int) (SceneController.screenHeight - cauldronSizes.get("height") - potionSizes.get("height") - allowance) ;
    ...
    public void generateCauldron() {
    	...
    	for (int i = 0;  i<4; i++) {
    		...
    		int y =  (int) SceneController.screenHeight - cauldronSize - bottomMargin;
    ...
    private void updateScore(int score) {
        ...
        gc.fillText(scoreText, (WINDOW_WIDTH - gc.getFont().getSize() * scoreText.length() / 2) / 2 + 30, 60);
    }
